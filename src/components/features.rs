...
impl Component for Features {
    ...
    fn view(&self, _ctx: &Context<Self>) -> Html {
        html! {
            <div class="flex w-full space-x-3 fill-white text-white">
                <div class="rounded-xl bg-indigo-400 px-4 py-3 flex justify-between items-center flex-1">
                ...
                <div class="rounded-xl bg-gray-100 fill-indigo-400 text-indigo-400 px-4 py-3 flex justify-between items-center flex-1">
